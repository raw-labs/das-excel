...
lazy val publishSettings = Seq(
  ...
  publishTo := Some("GitHub raw-labs Apache Maven Packages" at "https://maven.pkg.github.com/raw-labs/das-excel"),
...
lazy val dockerSettings = strictBuildSettings ++ Seq(
  ...
  dockerLabels ++= Map(
    ...
    "image-type" -> "final",
    "org.opencontainers.image.source" -> "https://github.com/raw-labs/das-excel"),
  ...
  dockerAliases := {
    val devRegistry = sys.env.getOrElse("DEV_REGISTRY", "ghcr.io/raw-labs/das-excel")
